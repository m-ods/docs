...
description: "The Entity Detection model lets you automatically identify and categorize key information in transcribed audio content."
---
...
<Check>
  Entity Detection is available in multiple languages. See [Supported languages](/getting-started/supported-languages).
</Check>
...
```
CanadalocationTimestamp: 2548 - 3130the USlocationTimestamp: 5498 - 6350...
```
...
```
curl https://api.assemblyai.com/v2/transcript \--header "Authorization: YOUR_API_KEY"  \--header "Content-Type: application/json" \--data '{  "audio_url": "YOUR_AUDIO_URL",  "entity_detection": true}'
```
