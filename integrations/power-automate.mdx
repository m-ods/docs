...
description: "Microsoft Power Automate is a low-code workflow automation platform with a rich collection of connectors to Microsoft's first-party services and third-party services.  is the equivalent service built for developers and IT pros."
---
...
1. 1
   ...
   ![Search for AssemblyAI actions in Power Automate](/images/docs/integrations/docs/assets/images/search-action-dd3d1bcb4db1ec4b28af95e53d12c385.png)
...
2. 2
   ...
   ![Create a connection to AssemblyAI in Power Automate](/images/docs/integrations/docs/assets/images/create-connection-56c24716f6162469a588a1bb46764d83.png)

3. 3

   Finally, configure your AssemblyAI action. Continue reading to learn more about all the available actions.

   ![Configure an AssemblyAI action in Power Automate](/images/docs/integrations/docs/assets/images/configure-action-da6724faf10827fbe9b734e647d39522.png)
...
## Transcribe Audio[​](#transcribe-audio "Direct link to Transcribe Audio")

To transcribe your audio, configure the `Audio URL` parameter using your audio file URL. Then, configure the additional parameters to enable more [Speech Recognition](https://www.assemblyai.com/docs/speech-to-text/speech-recognition) features and [Audio Intelligence](https://www.assemblyai.com/docs/audio-intelligence) models.
...
### Handle the Transcript Ready Webhook[​](#handle-the-transcript-ready-webhook "Direct link to Handle the Transcript Ready Webhook")
...
2. 2
   ...
   * Set `Request Body JSON Schema` to:
     ...
     ```
     {  "type": "object",  "properties": {    "transcript_id": {      "type": "string"    },    "status": {      "type": "string"    }  }}
     ```
...
### Poll the Transcript Status[​](#poll-the-transcript-status "Direct link to Poll the Transcript Status")
...
## Connector actions[​](#connector-actions "Direct link to Connector actions")

The AssemblyAI app for Power Automate provides the following actions:

### Files[​](#files "Direct link to Files")

#### Upload a Media File[​](#upload-a-media-file "Direct link to Upload a Media File")

Upload a media file to AssemblyAI's servers. You can pass the `Upload URL` output field to the `Audio URL` input field of [Transcribe an Audio File](#transcribe-audio) action.

### Transcripts[​](#transcripts "Direct link to Transcripts")

#### Transcribe Audio[​](#transcribe-audio-1 "Direct link to Transcribe Audio")
...
<Info>
  Configure your desired [Audio Intelligence models](/docs/audio-intelligence) when you create the transcript. The results of the models will be included in the transcript output when the transcript is completed.
</Info>
...
#### Get Paragraphs in Transcript[​](#get-paragraphs-in-transcript "Direct link to Get Paragraphs in Transcript")
...
#### Get Sentences in Transcript[​](#get-sentences-in-transcript "Direct link to Get Sentences in Transcript")
...
#### Get Subtitles for Transcript[​](#get-subtitles-for-transcript "Direct link to Get Subtitles for Transcript")
...
#### Get Redacted Audio[​](#get-redacted-audio "Direct link to Get Redacted Audio")
