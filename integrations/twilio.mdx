...
description: Learn how to integrate with Twilio
---

Twilio is a programmable communication platform for voice, messaging, and email.  
By combining Twilio with AssemblyAI, you can transcribe voice calls in [real-time](/docs/speech-to-text/streaming), and voice recordings and voice messages [asynchronously](/docs/speech-to-text/speech-recognition).  
Combine transcription with our [audio intelligence models](/docs/audio-intelligence) and [LeMUR LLM framework](/docs/lemur) to analyze the calls and messages.
