...
description: Learn how to integrate with LlamaIndex TypeScript
---

You can use the AssemblyAI readers from LlamaIndex.TS to transcribe audio files inside your LlamaIndex applications.

> **Note**  
> Looking for the Python integration? Check out the [LlamaIndex Python integration](/docs/integrations/llamaindex/python).
