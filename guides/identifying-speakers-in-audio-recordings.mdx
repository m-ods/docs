...
For more information, see the [Speaker Diarization model documentation](/speech-to-text/speaker-diarization#specifying-the-number-of-speakers) or see the [API reference](https://assemblyai.com/docs/api-reference/transcripts).
...
[API/Model Reference](/speech-to-text/speaker-diarization#specifying-the-number-of-speakers)
