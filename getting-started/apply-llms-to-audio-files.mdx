...
* An .
* Basic understanding of how to [Transcribe an audio file](/getting-started/transcribe-an-audio-file).
...
For more information about transcribing audio, see [Transcribe an audio file](/getting-started/transcribe-an-audio-file).
...
For more techniques on how to build prompts, see [Improving your prompt](/lemur/improving-your-prompt).
...
2. 2
   ...
   Create a custom task with LeMUR, using the transcript and prompt as input. The final model defines the LLM to use to process the task. For available models to choose from, see [Change the model type](/lemur/customize-parameters#change-the-model-type).
...
* [Ask questions about your audio data using LeMUR](/lemur/ask-questions)
* [Writing good prompts](/lemur/improving-your-prompt)
